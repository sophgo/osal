...
/**
 * @ingroup osal_proc
 * @brief Output formatted data to a seq_file or context object.
 *
 * @par Description:
 * This function outputs formatted data to the specified seq_file or context object, similar to printf-style formatting.
 * It is primarily used for writing formatted information into a sequence file or memory buffer.
 *
 * @param seqfile [in] Pointer to the seq_file or context object where the formatted data will be written.
 *                     The memory for this parameter must be properly allocated or initialized before calling the function.
 * @param fmt     [in] Format string specifying how subsequent arguments are formatted, similar to printf.
 * @param ...     [in] Variable arguments that match the format string.
 *
 * @return void.
 *
 * @par Support System:
