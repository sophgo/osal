 ...
 * @param osal_gfp_flag [in] The type of memory to alloc. This parameter is not used in rtos.
...
/**
 * @ingroup osal_addr
 * @brief Alloc dynamic memory, the memory is set to zero.
 *
 * @par Description:
 * This API is used to alloc a memory block of which the size is specified.
 *
 ...
 * @param osal_gfp_flag [in] The type of memory to alloc. This parameter is not used in rt_thread.
 * In linux, it must include one of the following access modes: OSAL_GFP_ATOMIC, OSAL_GFP_DMA, OSAL_GFP_KERNEL.
 * OSAL_GFP_ZERO can be bitwise-or'd in flags, Then, the memory is set to zero.
 * @param boundary [in] Boundary on which the memory is aligned. (unit: byte).
 *
 * @attention
 * when using osal_kmalloc_align malloc memory, should use osal_kfree_align release memory
 *
 * @par Support System:
 * rt_thread.
 */
...
/**
 * @ingroup osal_addr
 * @brief alloc virtually contiguous memory,the memory is set to zero.
 *
 * @par Description:
 * This API is used to alloc memory space with consecutive virtual addresses.
 *
 ...
 * This API is used to alloc a memory block of which the size is specified.
 *
 * @param size [in] How many bytes of memory is requested by a memory unit.
 * @param num [in] How many memory units are required.
 *
 *
 * @par Support System:
 * linux alios rt_thread.
 ...
 *
 * @par Description:
 * This API is used to release the allocated memory.
 *
 * @param addr [in] Starting address of the memory block to be freed.
 *
 * @par Support System:
...
/**
 * @ingroup osal_addr
 * @brief Set memory with a constant byte.
 *
 * @par Description:
 * This API is used to fill a block of memory with a particular value.
 *
 * @param s [out] Pointer to the block of memory to fill.
 * @param ch [in] Value to be set. The value is passed as an int,
 *			but the function fills the block of memory using the unsigned char conversion of this value.
 * @param n [in] Number of bytes to be set to the value.
 *
 * @par Support System:
 * linux  alios rt_thread.
 */
 ...
 *
 * @par Description:
 * This API is used to copy a block of memory from one location to another.
 *
 * @param dst [out] Pointer to the destination array where the content is to be copied.
 * @param src [in] Pointer to the source of data to be copied.
